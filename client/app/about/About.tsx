  ...
  return (
    <div className="text-black dark:text-white">
      ...
      <h1 className={`${styles.title} 800px:!text-[45px]`}>
        What is <span className="text-gradient">Shiksha Setu?</span>
      </h1>
      ...
      <div className="w-[95%] 800px:w-[85%] m-auto">
        <p className="text-[18px] font-Poppins">
          ...
          no further than ShikshaSetu, the premier programming community
          ...
          <br />
          <br />
          But ShikshaSetu is more than just a community &ndash; we&apos;re a
          ...
          <br />
          <br />
          With ShikshaSetu by your side, there&apos;s nothing standing between
          ...
          <br />
          <br />
          So what are you waiting for? Join the ShikshaSetu family today and
        ...
        <br />
        <span className="text-[22px]">Sanket Borade</span>
